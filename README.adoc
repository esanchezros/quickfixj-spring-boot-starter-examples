...
image:https://img.shields.io/badge/maven%20central-v2.6.0-blue.svg["Maven Central",link="https://search.maven.org/#search%7Cga%7C1%7Ca%3A%22quickfixj-spring-boot-starter-examples%22"]
